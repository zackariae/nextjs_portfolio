...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Redi School JS intermediate course</li>
        <li>Redi School UI/UX intermediate course</li>
        <li>Odessa national academy of telecommunications</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        ...
        <li>IBM Web Development Fundamentals </li>
      </ul>
    ),
  },
];
